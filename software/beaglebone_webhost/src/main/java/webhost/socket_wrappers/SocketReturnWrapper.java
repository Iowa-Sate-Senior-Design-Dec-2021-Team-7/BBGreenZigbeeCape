...
public class SocketReturnWrapper<T> {
    ...
    private ReturnObjectWrapper<T> payload;
     ...
     */
    public SocketReturnWrapper(int intent, ReturnObjectWrapper payload) {
     ...
     * 		{@code payload}
     */
    public ReturnObjectWrapper getPayload() { return payload; }
    /**
     * Set {@code payload} of {@code SocketIntentWrapper}
     * @param payload
     * 		Desired {@code payload} for {@code SocketIntentWrapper}
     */
    public void setPayload(ReturnObjectWrapper payload) { this.payload = payload; }
}
